function categorias() {
  ...
  <symbol id="exclamation-triangle-fill" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div id="erro_nome" class="alert alert-danger d-flex align-items-center d-none" role="alert">
  <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
  <div>
    Nome invalido
  </div>
</div>
       <div id="erro_descricao" class="alert alert-danger d-none d-flex align-items-center d-none" role="alert">
  <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
  <div>
    Descrição invalida
  </div>
