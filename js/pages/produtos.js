function produtos() {
  return `
    <div class="d-flex justify-content-between">
      <h1>Produtos</h1>
      <a class="btn btn-dark " onclick="alterarConteudo('cadastrarProduto')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
